                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 8),
                          _buildDebtDetailRow('Due Date:', lender['dueDate']),
                          _buildDebtDetailRow('Amount to Pay:', '\₹${lender['amount']}'),
                          _buildDebtDetailRow('Amount Taken On:', lender['takenOn']),
                          _buildDebtDetailRow('Principal Amount:', '\₹${lender['principal']}'),
                          _buildDebtDetailRow('Interest:', '\₹${lender['interest']} (${lender['interestRate']}%)'),
                          _buildDebtDetailRow('Total Amount:', '\₹${lender['amount']}'),
                        ],
                      ),
                    ),
                  );
